require(["readerView"], function (ReaderView) {

    var pWorker = function () {

        function cacheDefaultPagination(openBookData, readerOptions) {
...
//        });
        ...
        onmessage = function (event) {
            ...
            switch (command) {
                ...
                case "create":
                    cacheDefaultPagination(JSON.parse(data.openBookData), JSON.parse(data.readerOptions));
                    break;
                default:
